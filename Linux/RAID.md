...
### RAID 0  
la configuration RAID 0 permet d'améliorer la performance du système en répartissant 50% des données sur un disque et 50% sur l'autre.  # RAID (Redundant Array of Inexpensive Disks)  
---
<details>
<summary>
<h2>
